...
* 论文分享：1.我在Performer中发现了Transformer-VQ的踪影 2.多模态理解benchmark新发布！
* 讨论：1.LLama2 预测结果差距 2.LLama 的 tokenizer 和 titoken 本质区别 3.特定的domain的self-instruct方法 4.大模型SFT阶段训练不稳定的探索
